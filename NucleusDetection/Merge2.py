...
# NOTE: the "cv2.waitKey(0)" do not work on window
# normally they are commanted, if not do so
...
if __name__ == '__main__':
    ...
    for contour in contours:
        ...
        if (area > 10000):#((len(approx) > 8) & (area > 10000)): #& (area < 20000)):
...
##
    ...
    cv2.imwrite('CellsFound.png', dst)
##
    ...
    #cv2.waitKey(0)
    ####################################################################################################################
    # marche bien jusqu'a la => detection cell :)
...
#
    ...
    #
        ...
        #cv2.imshow('out 2', im) # noyau clair => MAX
    ...
    #
        ...
        cv2.imshow('out', out) # noyau fonce => MIN
        #cv2.waitKey(0)
        ...
        percentageInterest = 0.03 # take first 20%
        # idee: choisir un pourcentage qui depend de la moyenne ou de la position du groupe de c
        # 0.01 bon pour c centrale
        # 0.03 tous les noyaux mais aussi de la merde a cote
        #maximum = 0.2 * tot
    ...
    cv2.imwrite('NucleusFound.png', frame)
    cv2.waitKey(0)
